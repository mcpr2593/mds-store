                            ...
                            <div class="card-body">
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                                    ...
                                    <div class="flex flex-col lg:col-span-4">
                                        <div>
                                            <h5 class="mb-1 text-16"><a href="apps-ecommerce-product-overview.html">Roar Twill Blue Baseball Cap</a></h5>
                                            <p class="mb-2 text-slate-500 dark:text-zink-200"><a href="#!">Men's Fashion</a></p>
                                            <p class="mb-1 text-slate-500 dark:text-zink-200">Color: <span class="text-slate-800 dark:text-zink-50">White/Blue</span></p>
